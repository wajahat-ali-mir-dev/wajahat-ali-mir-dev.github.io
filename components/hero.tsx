  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-24 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-20 right-10 w-[500px] h-[500px] bg-accent/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-(--neon-purple)/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
            ...
            <ScrollAnimation direction="left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start">
                <button
                  ...
                  className="group relative px-8 py-4 bg-linear-to-r from-accent to-(--neon-cyan) text-accent-foreground rounded-xl font-semibold flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-xl hover:shadow-accent/25 hover:scale-105"
                >
          ...
          <div className="lg:col-span-2 hidden lg:flex justify-center">
            <ScrollAnimation direction="right" delay={0.2}>
              <div className="relative">
                <div className="absolute -inset-4 bg-linear-to-r from-accent/20 via-(--neon-purple)/20 to-(--neon-cyan)/20 rounded-3xl blur-2xl animate-pulse-glow" />
                <div className="absolute -inset-1 bg-linear-to-r from-accent via-(--neon-purple) to-(--neon-cyan) rounded-2xl opacity-20 blur-sm" />
                ...
                <div className="absolute -bottom-4 -left-4 w-16 h-16 rounded-xl glass border border-(--neon-purple)/30 flex items-center justify-center animate-float" style={{ animationDelay: '1s' }}>
